		...
		<div class="container-fluid">
			...
			<div class="row">
	                ...
	                <?php
	                	...
	                	$sql_act="SELECT * FROM loteria WHERE activo='1' AND cedula='".$_SESSION["usuario"]."' AND (fecha BETWEEN '".$desde."' AND '".$hasta."')";
	                    ...
	                    while ($row_act=mysqli_fetch_array($rs_act)) {
	                    		...
	                    		echo"<tr>";
	                    			echo"<td>";
	                    				echo "<a href='con_u_normal_l.php?codigo=".$row_act["codigo"]."&desde=".$desde."&hasta=".$hasta."'>".$row_act["codigo"]."</a>";
	                    			echo"</td>";
	                    			echo"<td>";
