		...
		<div class="container">
			...
			<div class="row">
				...
				<?php
					...
					$sql_partido="SELECT c.competicion, c.id_competicion, p.* FROM partidos p JOIN competiciones c ON c.id_competicion=p.id_competicion WHERE p.id = '".$_GET["id_partido"]."'";
					$rs_partido=mysqli_query($mysqli, $sql_partido) or die(mysqli_error());
					$row_partido=mysqli_fetch_array($rs_partido);

					$sql_local="SELECT id, equipo FROM equipos WHERE id='".$row_partido["equipo2"]."'";

		            $rs_local=mysqli_query($mysqli,$sql_local) or die(mysqli_error($mysqli));

		            $row_local=mysqli_fetch_array($rs_local);

		            $sql_visitante="SELECT id, equipo FROM equipos WHERE id='".$row_partido["equipo1"]."'";
				...
				<center><h2>Modificar Partido</h2></center><br>
			</div>
			<div class="form-group">
					    	
			<div class="row">
				<form class="form-horizontal" action="mod_partido.php" method="POST">
				<input type="hidden" name="dep" id="dep" value="<?php echo $deporte;?>">
				<input type="hidden" name="id_partido" id="id_partido" value="<?php echo $row_partido["id"];?>">
				...
				<div class="col-sm-6 col-sm-offset-3">
					<div class="form-group">
						...
						<div class="col-sm-8">
						    <input type="text" required autocomplete="off" onkeyup="bus_h()" class="form-control" name="comp" id="comp" placeholder="Liga o Competición" title="Liga o Competición" value="<?php echo $row_partido["competicion"]; ?>">
						    <input type="hidden" name="compe_selec" id="compe_selec" value="<?php echo $row_partido["id_competicion"] ?>"><div id="suggestions"></div>
						</div>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
					    	...
					    	<div class="col-sm-8">
					      		<input type="text" required class="form-control" name="fecha" id="fecha" placeholder="Fecha Colombia" title="Fecha Colombia" autocomplete="off" value="<?php echo $row_partido["fecha"] ?>">
					    	</div>
					  	</div>
					  	<div class="form-group">
					    	
					    	<div class="col-sm-8">
					      		<input type="text" required class="form-control" name="hora" id="hora" placeholder="Hora Colombia HH:MM:SS" title="Hora Colombia HH:MM:SS" value="<?php echo $row_partido["hora"] ?>">
					    	</div>
					  	</div>
				</div><br><br>
				<div class="col-sm-6">
						<div class="form-group">
							<div class="col-sm-8">
					      		<input type="text" required class="form-control" name="fecha_v" id="fecha_v" placeholder="Fecha México" title="Fecha México" autocomplete="off" value="<?php echo $row_partido["fecha_v"] ?>">
					    	</div>
					  	</div>
					  	<div class="form-group">
					    	
					    	<div class="col-sm-8">
					      		<input type="text" required class="form-control" name="hora_v" id="hora_v" placeholder="Hora México HH:MM:SS" title="Hora México HH:MM:SS" value="<?php echo $row_partido["hora_v"] ?>"><br>
					    	</div>
					  	</div>
				</div>
			</div>
			<div class="row">
					<div class="col-sm-6">
					  	...
					  	<div class="form-group">
					    	<div class="col-sm-8">
					      		<input type="text" required class="form-control" autocomplete="off" onkeyup="bus_h3()" name="equipo2" id="equipo2" placeholder="Equipo local" title="Equipo local" value="<?php echo $row_local["equipo"] ?>">
					      		<input type="hidden" name="equipo2_selec" id="equipo2_selec" value="<?php echo $row_local["id"] ?>"><div id="suggestions3" ></div>
					    	</div>
					  	</div>
					</div>
					<div class="col-sm-6">
					  	<div class="form-group">
					    	<div class="col-sm-8">
					      		<input type="text" required class="form-control" autocomplete="off" onkeyup="bus_h2()" name="equipo1" id="equipo1" placeholder="Equipo visitante" title="Equipo visitante" value="<?php echo $row_visitante["equipo"] ?>">
					      		<input type="hidden" name="equipo1_selec" id="equipo1_selec" value="<?php echo $row_visitante["id"] ?>"><div id="suggestions2"></div>
					    	</div>
					  	</div>
			...
			<div class="row">
				...
				<div class="col-sm-4">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
						    <input type="text" required class="form-control" name="v_alta" id="v_alta" placeholder="Valor Alta" title="Valor Alta" value="<?php echo $row_partido["v_alta"] ?>">
						</div>
					</div>
			...
			<div class="row">
				<div class="col-sm-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
						    <input type="text" required class="form-control" name="v_runline2" id="v_runline2" placeholder="Valor RL local" title="Valor RL local" value="<?php echo $row_partido["v_runline2"] ?>">
						</div>
					</div>
				...
				<div class="col-sm-3">
						...
						<div class="col-sm-8">
						    <input type="text" required class="form-control" name="v_runline1" id="v_runline1" placeholder="Valor RL visitante" title="Valor RL visitante" value="<?php echo $row_partido["v_runline1"] ?>">
						</div>
					</div>
				</div>
				<div class="col-sm-3">
			...
			<div class="row">
				<div class="form-group">
				    <div class="col-sm-offset-4 col-sm-8">
				      	<button type="submit" class="btn btn-success">Modificar Partido</button>
				    </div>
				</div>
			</div>	  		  	
