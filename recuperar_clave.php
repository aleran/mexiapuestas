...
<html>
	...
	<body>
		<h1 class="w3ls">Ingresa los datos para restablecer tu contraseña</h1>
			<div class="content-agileits">
				<form action="rec_clave.php" name="registro" method="POST" data-toggle="validator" role="form">
					...
					<div class="form-group">
						<button type="submit" class="btn btn-lg">Recuperar</button>
					</div>
				</form>
		    </div>
		<br><br><br><br><br><br><br><br><p class="copyright-w3ls">© 2018 Derechos Reservados mexiapuestas.net</b></p>
		<!-- js files -->
