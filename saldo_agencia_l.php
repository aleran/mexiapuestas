		...
		<div class="container-fluid">
			...
			<div class="row">
				<?php
                          if ($_SESSION["tipo"]=="root") {
                            ...
                            $sql_sum="SELECT SUM(monto) AS t_monto FROM loteria WHERE agencia='".$_POST["agencia"]."' AND activo='1' AND cedula='' AND (fecha BETWEEN '".$_POST["desde"]."' AND '".$_POST["hasta"]."')";
                            $rs_sum=mysqli_query($mysqli,$sql_sum) or die(mysqli_error());
                            $row_sum=mysqli_fetch_array($rs_sum);


                            $sql_perdi="SELECT SUM(monto) AS m_perdido, SUM(premio) AS arr_perdido FROM loteria WHERE agencia='".$_POST["agencia"]."' AND (ganar='1' OR ganar='2' OR ganar='4') AND activo='1' AND cedula='' AND (fecha BETWEEN '".$_POST["desde"]."' AND '".$_POST["hasta"]."')";
                            ...
                            $sql_sum="SELECT SUM(monto) AS t_monto FROM loteria WHERE agencia='".$_SESSION["agencia"]."' AND activo='1' AND cedula='' AND (fecha BETWEEN '".$_POST["desde"]."' AND '".$_POST["hasta"]."')";
                            $rs_sum=mysqli_query($mysqli,$sql_sum) or die(mysqli_error());
                            $row_sum=mysqli_fetch_array($rs_sum);


                            $sql_perdi="SELECT SUM(monto) AS m_perdido, SUM(premio) AS arr_perdido FROM loteria WHERE agencia='".$_SESSION["agencia"]."'  AND (ganar='1' OR ganar='2' OR ganar='4') AND activo='1' AND cedula='' AND (fecha BETWEEN '".$_POST["desde"]."' AND '".$_POST["hasta"]."')";
                            $rs_perdi=mysqli_query($mysqli,$sql_perdi) or die(mysqli_error());
                             $row_perdi=mysqli_fetch_array($rs_perdi);
            ...
            <?php
                        if ($_SESSION["tipo"]=="root") {
                            ...
                            $sql_sum1="SELECT SUM(monto) AS t_monto FROM loteria WHERE agencia='".$_POST["agencia"]."' AND activo='1' AND cedula !='' AND (fecha BETWEEN '".$_POST["desde"]."' AND '".$_POST["hasta"]."')";
                            $rs_sum1=mysqli_query($mysqli,$sql_sum1) or die(mysqli_error());
                            $row_sum1=mysqli_fetch_array($rs_sum1);


                            $sql_perdi1="SELECT SUM(monto) AS m_perdido, SUM(premio) AS arr_perdido FROM loteria WHERE agencia='".$_POST["agencia"]."' AND (ganar='1' OR ganar='2' OR ganar='4') AND activo='1' AND cedula !='' AND (fecha BETWEEN '".$_POST["desde"]."' AND '".$_POST["hasta"]."')";
                            ...
                            $sql_sum1="SELECT SUM(monto) AS t_monto FROM loteria WHERE agencia='".$_SESSION["agencia"]."' AND activo='1' AND cedula !='' AND (fecha BETWEEN '".$_POST["desde"]."' AND '".$_POST["hasta"]."')";
                            $rs_sum1=mysqli_query($mysqli,$sql_sum1) or die(mysqli_error());
                            $row_sum1=mysqli_fetch_array($rs_sum1);


                            $sql_perdi1="SELECT SUM(monto) AS m_perdido, SUM(premio) AS arr_perdido FROM loteria WHERE agencia='".$_SESSION["agencia"]."'  AND (ganar='1' OR ganar='2' OR ganar='4') AND activo='1' AND cedula !='' AND (fecha BETWEEN '".$_POST["desde"]."' AND '".$_POST["hasta"]."')";
                            $rs_perdi1=mysqli_query($mysqli,$sql_perdi1) or die(mysqli_error());
                             $row_perdi1=mysqli_fetch_array($rs_perdi1);
