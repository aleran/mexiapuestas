		...
		<div class="container-fluid">
			...
			<div class="row">
				<?php
                            ...
                            $sql_sum="SELECT SUM(monto) AS t_monto FROM parlay p JOIN agencias a ON p.agencia=a.id WHERE a.agencia_padre='".$_POST["agencia"]."' AND activo='1' AND cedula='' AND (fecha BETWEEN '".$_POST["desde"]."' AND '".$_POST["hasta"]."')";
                            $rs_sum=mysqli_query($mysqli,$sql_sum) or die(mysqli_error());
                            $row_sum=mysqli_fetch_array($rs_sum);


                            $sql_perdi="SELECT SUM(monto) AS m_perdido, SUM(premio) AS arr_perdido FROM parlay p JOIN agencias a ON p.agencia=a.id  WHERE a.agencia_padre='".$_POST["agencia"]."' AND ganar='1' AND activo='1' AND cedula='' AND (fecha BETWEEN '".$_POST["desde"]."' AND '".$_POST["hasta"]."')";
                            ...
                            $sql_recargas="SELECT SUM(monto) AS t_recargas FROM trans_usuario p JOIN agencias a ON p.agencia=a.id WHERE a.agencia_padre='".$_POST["agencia"]."' AND tipo='recarga' AND (fecha BETWEEN '".$_POST["desde"]."' AND '".$_POST["hasta"]."')";
                            $rs_recargas=mysqli_query($mysqli,$sql_recargas) or die(mysqli_error());
                            $row_recargas=mysqli_fetch_array($rs_recargas);

                            $sql_pagos="SELECT SUM(monto) AS t_pagos FROM trans_usuario p JOIN agencias a ON p.agencia=a.id  WHERE a.agencia_padre='".$_POST["agencia"]."' AND tipo='pago' AND (fecha BETWEEN '".$_POST["desde"]."' AND '".$_POST["hasta"]."')";
                ...
                <div class="row">
                    ...
                    <?php
                            ...
                            echo '<h3><center>Resumen económico de Agencias asocioadas a:&nbsp;'; echo $row ["agencia"]; echo '</center></h3>';
            ...
            <?php
                            ...
                            $sql_sum1="SELECT SUM(monto) AS t_monto FROM parlay p JOIN agencias a ON p.agencia=a.id WHERE a.agencia_padre='".$_POST["agencia"]."' AND activo='1' AND cedula!='' AND (fecha BETWEEN '".$_POST["desde"]."' AND '".$_POST["hasta"]."')";
                            $rs_sum1=mysqli_query($mysqli,$sql_sum1) or die(mysqli_error());
                            $row_sum1=mysqli_fetch_array($rs_sum1);


                            $sql_perdi1="SELECT SUM(monto) AS m_perdido, SUM(premio) AS arr_perdido FROM parlay  p JOIN agencias a ON p.agencia=a.id WHERE a.agencia_padre='".$_POST["agencia"]."' AND ganar='1' AND activo='1' AND cedula!='' AND (fecha BETWEEN '".$_POST["desde"]."' AND '".$_POST["hasta"]."')";
