	<div class="aside">
		...
		<nav>
			<ul id="menu_principal">
				<li><a href="http://mexiapuestas.com"><span class="mif-home mif-3x principales"></span>VOLVER</a></li>

				<li><a href="http://mexiapuestas.com/registro_usuario.php" target="_blank"><span class="mif-user-plus mif-3x principales"></span>REGISTRATE</a></li>		
